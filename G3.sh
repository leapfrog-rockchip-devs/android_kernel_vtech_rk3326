...
#	make ARCH=arm64 BOOT_IMG=../rockdev/Image-rk3326_qgo/boot.img rk3326-Epicmipi.img -j12
	make ARCH=arm64 BOOT_IMG=../rockdev/Image-rk3326_qgo/boot.img rk3326-863-lp3-v10-rkisp1.img -j12
#cd ../u-boot/

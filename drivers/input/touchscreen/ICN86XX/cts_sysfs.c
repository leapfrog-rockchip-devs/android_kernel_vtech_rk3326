...
#define PRINT_ROW_SIZE          (16)
    ...
    ret = kstrtou16(argv[0], 0, &addr);
    if (ret) {
        return snprintf(buf, 255, "Invalid address: %s\n", argv[0]);
    }
    ret = kstrtou16(argv[1], 0, &size);
    if (ret) {
        return snprintf(buf, 255, "Invalid size: %s\n", argv[1]);
    }
        ...
        struct device_attribute *attr, char *buf)
{
    ...
    return snprintf(buf, 255, "Updating: %s\n",
...
static struct attribute *cts_dev_firmware_atts[] = {
    ...
    NULL,   // vicsiu 2021-09-29: disable the followings
        ...
        struct device_attribute *attr, char *buf)
{
    ...
    if (ret) {
        return snprintf(buf, 255, "Invalid version: %s\n", argv[0]);
    }
        ...
        struct device_attribute *attr, char *buf)
{
    ...
    if (ret) {
        return snprintf(buf, 255, "Invalid threshold_min: %s\n", argv[0]);
    }
    ret = kstrtou16(argv[1], 0, &th_max);
    if (ret) {
        return snprintf(buf, 255, "Invalid threshold_max: %s\n", argv[1]);
    }
        ...
        struct device_attribute *attr, char *buf)
{
    ...
    if (ret) {
        return snprintf(buf, 255, "Invalid threshold: %s\n", argv[0]);
    }
        ...
        struct device_attribute *attr, char *buf)
{
    ...
    return snprintf(buf, 255, "Testting: %s\n",
        ...
        struct device_attribute *attr, char *buf)
{
    ...
    return snprintf(buf, 255, "IC Type : %s\n",
        ...
        struct device_attribute *attr, char *buf)
{
    ...
    return snprintf(buf, 255, "Program mode: %s\n",
        ...
        struct device_attribute *attr, char *buf)
{
    ...
    return snprintf(buf, 255, "Normal mode: %s\n",
        ...
        struct device_attribute *attr, char *buf)
{
    ...
    return snprintf(buf, 255, "is device enabled: %s\n",
        ...
        struct device_attribute *attr, char *buf)
{
    ...
    return snprintf(buf, 255, "esd check enabled: %s\n",

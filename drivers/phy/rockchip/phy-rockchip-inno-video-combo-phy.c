...
struct inno_video_phy_plat_data {
	...
	enum phy_max_rate max_rate;
	const struct inno_video_phy_info **mipi_dphy_timing_infos;
};
...
inno_mipi_dphy_get_timing(struct inno_video_phy *inno)
{
	...
	enum phy_max_rate index;
	unsigned int i;

	index = inno->max_rate;
	timings = inno->pdata->mipi_dphy_timing_infos[index]->inno_mipi_dphy_timing_table;
	num_timings = inno->pdata->mipi_dphy_timing_infos[index]->num_timings;
...
{
	inno->max_rate = soc_is_px30s() ? MAX_2_5GHZ : inno->pdata->max_rate;
...
static const
struct inno_video_phy_info inno_mipi_dphy_timing_max_1GHz = {
	.num_timings = ARRAY_SIZE(inno_mipi_dphy_timing_table_max_1GHz),
	.inno_mipi_dphy_timing_table = inno_mipi_dphy_timing_table_max_1GHz,
};

static const
struct inno_video_phy_info inno_mipi_dphy_timing_max_2_5GHz = {
	.num_timings = ARRAY_SIZE(inno_mipi_dphy_timing_table_max_2_5GHz),
	.inno_mipi_dphy_timing_table = inno_mipi_dphy_timing_table_max_2_5GHz,
};

static const
struct inno_video_phy_info *inno_mipi_dphy_timing_infos[MAX_RATE] = {
	[MAX_1GHZ] = &inno_mipi_dphy_timing_max_1GHz,
	[MAX_2_5GHZ] = &inno_mipi_dphy_timing_max_2_5GHz,
};

static const struct inno_video_phy_plat_data px30_video_phy_plat_data = {
	.soc_type = PX30,
	.max_rate = MAX_1GHZ,
	.mipi_dphy_timing_infos = inno_mipi_dphy_timing_infos,
};

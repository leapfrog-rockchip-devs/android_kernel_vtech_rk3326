...
static char mmc_cid[128] = {0};
const char *get_mmc_cid(void)
{
	return mmc_cid;
}
EXPORT_SYMBOL(get_mmc_cid);

static int __init parse_mmc_id(char *str)
{
	strcpy(mmc_cid, str);
	return 1;
}

__setup("androidboot.cid=", parse_mmc_id);
